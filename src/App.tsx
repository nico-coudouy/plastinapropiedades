        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-serif font-bold text-navy hidden sm:block">Plastina Admin</h1>
            </div>
            <div className="flex items-center gap-4">
              <button 
                onClick={() => { setEditingProperty(null); setShowForm(true); }}
                className="bg-gold hover:bg-gold-light text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-bold transition-all shadow-md"
              >
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              >
                <div className="flex items-center justify-between mb-8 border-b border-gray-100 pb-4">
                  ...
                  <button onClick={() => setShowForm(false)} className="text-gray-400 hover:text-navy">
                    <X size={24} />
                  </button>
                </div>
